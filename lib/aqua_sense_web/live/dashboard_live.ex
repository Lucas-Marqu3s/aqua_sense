defmodule AquaSenseWeb.DashboardLive do
  ...
  @level [74.2, 73.6, 73.0, 72.4, 71.8, 71.1, 70.5, 69.8, 69.1, 68.4, 67.6, 66.9, 66.1, 65.4,
          64.6, 63.9, 63.1, 62.4, 61.8, 61.2, 60.7, 60.3, 59.9, 59.6, 62.8, 68.4, 74.9, 80.2,
          84.1, 86.3, 87.1, 86.8, 86.3, 85.7, 85.0, 84.3, 83.5, 82.8, 82.0, 81.3, 80.5, 79.8,
          79.0, 78.3, 77.6, 76.9, 76.3, 75.8]

  @temperature [23.9, 23.8, 23.8, 23.7, 23.7, 23.6, 23.6, 23.5, 23.5, 23.4, 23.4, 23.4, 23.3,
                23.3, 23.3, 23.4, 23.5, 23.6, 23.8, 23.9, 24.1, 24.2, 24.3, 24.4, 24.2, 23.9,
                23.6, 23.4, 23.3, 23.3, 23.4, 23.5, 23.7, 23.9, 24.1, 24.3, 24.5, 24.7, 24.8,
                24.9, 24.9, 24.8, 24.7, 24.6, 24.5, 24.4, 24.3, 24.3]

  @turbidity [1.9, 1.9, 2.0, 2.0, 2.1, 2.1, 2.2, 2.2, 2.3, 2.3, 2.4, 2.4, 2.5, 2.5, 2.6, 2.6,
              2.7, 2.7, 2.8, 2.8, 2.9, 2.9, 3.0, 3.0, 4.9, 6.2, 5.4, 4.6, 4.0, 3.6, 3.3, 3.1,
              3.0, 2.9, 2.9, 2.8, 2.8, 2.8, 2.9, 2.9, 3.0, 3.0, 3.1, 3.1, 3.2, 3.2, 3.2, 3.2]

  @conductivity [286, 288, 290, 292, 295, 297, 299, 302, 304, 306, 309, 311, 313, 316, 318, 320,
                 323, 325, 327, 330, 332, 334, 337, 339, 330, 318, 309, 304, 302, 303, 306, 310,
                 315, 320, 326, 331, 337, 342, 348, 353, 358, 362, 367, 371, 375, 378, 381, 384]
  ...
  defp parameter_view(parameter) do
    ...
    |> Map.merge(%{
      ...
      small:
        Chart.build(values, x0: 40, x1: 296, y0: 10, y1: 92, min: scale_min, max: scale_max),
